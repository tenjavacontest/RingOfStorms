...
public class PetCow extends EntityCow implements PetEntity {

	private final EntityPets plugin;

	public PetCow(World arg0, EntityPets plugin) {
		this(arg0, plugin, null);
	}
	
	public PetCow(World arg0, EntityPets plugin, String owner) {
		super(arg0);
		this.plugin = plugin;
		if(owner != null)
			setOwner(owner);
