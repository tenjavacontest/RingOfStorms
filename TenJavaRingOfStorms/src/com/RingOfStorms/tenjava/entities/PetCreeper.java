...
public class PetCreeper extends EntityCreeper implements PetEntity {

	private final EntityPets plugin;

	public PetCreeper(World arg0, EntityPets plugin) {
		this(arg0, plugin, null);
	}
	
	public PetCreeper(World arg0, EntityPets plugin, String owner) {
		super(arg0);
		this.plugin = plugin;
		if(owner != null)
			setOwner(owner);
