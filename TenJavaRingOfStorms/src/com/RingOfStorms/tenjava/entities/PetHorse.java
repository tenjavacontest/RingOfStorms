...
public class PetHorse extends EntityHorse implements PetEntity {

	private final EntityPets plugin;

	public PetHorse(World arg0, EntityPets plugin) {
		this(arg0, plugin, null);
	}
	
	public PetHorse(World arg0, EntityPets plugin, String owner) {
		super(arg0);
		this.plugin = plugin;
		if(owner != null)
			setOwner(owner);
