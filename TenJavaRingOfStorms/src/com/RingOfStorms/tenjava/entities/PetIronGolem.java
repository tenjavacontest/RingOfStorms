...
public class PetIronGolem extends EntityIronGolem implements PetEntity {

	private final EntityPets plugin;

	public PetIronGolem(World arg0, EntityPets plugin) {
		this(arg0, plugin, null);
	}
	
	public PetIronGolem(World arg0, EntityPets plugin, String owner) {
		super(arg0);
		this.plugin = plugin;
		if(owner != null)
			setOwner(owner);
