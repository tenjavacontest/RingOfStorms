...
public class PetMushroomCow extends EntityMushroomCow implements PetEntity {

	private final EntityPets plugin;

	public PetMushroomCow(World arg0, EntityPets plugin) {
		this(arg0, plugin, null);
	}
	
	public PetMushroomCow(World arg0, EntityPets plugin, String owner) {
		super(arg0);
		this.plugin = plugin;
		if(owner != null)
			setOwner(owner);
