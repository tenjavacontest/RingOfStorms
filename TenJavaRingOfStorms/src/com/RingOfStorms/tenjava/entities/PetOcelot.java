...
public class PetOcelot extends EntityOcelot implements PetEntity {

	private final EntityPets plugin;

	public PetOcelot(World arg0, EntityPets plugin) {
		this(arg0, plugin, null);
	}
	
	public PetOcelot(World arg0, EntityPets plugin, String owner) {
		super(arg0);
		this.plugin = plugin;
		if(owner != null)
			setOwner(owner);
