...
public class PetPigZombie extends EntityPigZombie implements PetEntity {

	private final EntityPets plugin;

	public PetPigZombie(World arg0, EntityPets plugin) {
		this(arg0, plugin, null);
	}
	
	public PetPigZombie(World arg0, EntityPets plugin, String owner) {
		super(arg0);
		this.plugin = plugin;
		if(owner != null)
			setOwner(owner);
