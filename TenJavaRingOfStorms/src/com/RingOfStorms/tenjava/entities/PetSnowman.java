...
public class PetSnowman extends EntitySnowman implements PetEntity {

	private final EntityPets plugin;

	public PetSnowman(World arg0, EntityPets plugin) {
		this(arg0, plugin, null);
	}
	
	public PetSnowman(World arg0, EntityPets plugin, String owner) {
		super(arg0);
		this.plugin = plugin;
		if(owner != null)
			setOwner(owner);
