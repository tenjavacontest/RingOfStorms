...
public class PetWitch extends EntityWitch implements PetEntity {

	private final EntityPets plugin;

	public PetWitch(World arg0, EntityPets plugin) {
		this(arg0, plugin, null);
	}
	
	public PetWitch(World arg0, EntityPets plugin, String owner) {
		super(arg0);
		this.plugin = plugin;
		if(owner != null)
			setOwner(owner);
