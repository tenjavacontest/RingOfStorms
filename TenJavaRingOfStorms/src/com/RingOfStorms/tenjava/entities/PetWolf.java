...
public class PetWolf extends EntityWolf implements PetEntity {

	private final EntityPets plugin;

	public PetWolf(World arg0, EntityPets plugin) {
		this(arg0, plugin, null);
	}
	
	public PetWolf(World arg0, EntityPets plugin, String owner) {
		super(arg0);
		this.plugin = plugin;
		if(owner != null)
			setOwner(owner);
